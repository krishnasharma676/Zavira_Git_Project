  ...
  return (
    <div className="space-y-4 animate-in fade-in duration-500 max-w-[1400px]">
      <header className="flex justify-between items-center border-b border-gray-100 pb-2">
        <div>
          <h1 className="text-lg font-sans font-black uppercase tracking-tight text-gray-900 leading-none">Pages</h1>
          <p className="text-gray-400 text-[8px] font-bold uppercase tracking-widest mt-1">Manage website content</p>
        </div>
        <button className="bg-white border border-gray-100 px-3 py-1.5 rounded-lg text-[9px] font-black uppercase tracking-widest text-gray-500 hover:text-[#7A578D] transition-all flex items-center space-x-2">
          <Globe size={12} />
        ...
        <div className="space-y-3">
           <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              <div className="space-y-1">
                ...
                <input type="text" defaultValue={editingPage?.title} className="w-full bg-gray-50 border border-gray-100 rounded-lg py-1.5 px-3 outline-none focus:border-[#7A578D] text-[11px] font-black uppercase" />
              </div>
              <div className="space-y-1">
                <label className="text-[9px] font-black uppercase tracking-widest text-gray-400 ml-1">Path</label>
                <input type="text" readOnly defaultValue={editingPage?.path} className="w-full bg-gray-50 border border-gray-100 rounded-lg py-1.5 px-3 outline-none text-[10px] font-black tracking-widest text-gray-400" />
              </div>
           </div>
           ...
           <div className="space-y-1">
              ...
              <textarea 
                rows={6}
                className="w-full p-3 bg-gray-50 border border-gray-100 rounded-lg outline-none text-[11px] font-black uppercase tracking-tight leading-relaxed text-gray-700 resize-none"
           ...
           <div className="p-3 bg-gray-50 border border-gray-50 rounded-xl">
              <div className="flex items-center space-x-2 mb-2">
                 <Database size={11} className="text-[#7A578D]" />
                 <h4 className="text-[9px] font-black uppercase tracking-widest text-gray-900">SEO Metadata</h4>
              </div>
              <textarea 
                rows={2} 
                className="w-full bg-white border border-gray-100 rounded-lg p-2 outline-none focus:border-[#7A578D] text-[10px] text-gray-500 tracking-tight leading-relaxed italic" 
                placeholder="Meta description..."
              />
           </div>

           <button className="w-full bg-[#7A578D] text-white py-2.5 rounded-lg text-[10px] font-black uppercase tracking-widest hover:bg-black transition-all">
              Save Changes
           </button>
        </div>
      </ManagementModal>
