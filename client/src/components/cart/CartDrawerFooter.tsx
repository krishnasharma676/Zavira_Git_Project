  ...
  return (
    <div className="p-8 border-t border-gray-50 dark:border-white/5 bg-white dark:bg-[#0A0A0A] space-y-6">
      <div className="space-y-3">
        ...
        <div className="flex justify-between items-center">
          <span className="text-[10px] font-black uppercase tracking-widest text-gray-400">Shipping Fees</span>
        ...
        {subtotal < freeShippingThreshold && (
          <div className="pt-2">
            ...
            <p className="text-[8px] font-bold uppercase tracking-[0.2em] text-gray-400 mt-2 text-center">
               Add <span className="text-[#C9A0C8]">{formatCurrency(freeShippingThreshold - subtotal)}</span> for free shipping
            </p>
          </div>
        )}
      </div>
      ...
      <div className="space-y-4">
        <div className="flex justify-between items-end border-t border-gray-50 dark:border-white/5 pt-4">
           <div>
              <span className="text-[9px] font-black uppercase tracking-[0.3em] text-gray-400 block mb-1">Total Amount</span>
