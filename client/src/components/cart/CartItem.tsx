         ...
         <div className="flex justify-between items-start mb-4">
            <div>
               ...
               <div className="flex items-center gap-4">
                  ...
                  {item.selectedSize && (
                    <span className="text-[10px] font-black uppercase tracking-widest text-[#7A578D] bg-[#7A578D]/5 px-2 py-0.5 rounded">Size: {item.selectedSize}</span>
                  )}
                  <span className="text-[10px] font-black uppercase tracking-widest text-green-500 bg-green-50 dark:bg-green-500/10 px-2 py-0.5 rounded">In Stock</span>
               </div>
